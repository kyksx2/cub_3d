...
/*   Updated: 2025/08/07 17:00:51 by kjolly           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    init_data(t_data *cube, char *av)
{
	...
	cube->texture.data = mlx_get_data_addr(cube->texture.img, &cube->texture.bpp, &cube->texture.line_len, &cube->texture.endian);
